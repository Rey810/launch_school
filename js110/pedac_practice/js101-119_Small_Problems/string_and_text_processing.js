...
/*
SEARCH WORD (PART TWO)

- input
-> word and string of multiple words
- output
-> string with found words highlighted and uppercased

*/

function searchWord(wordArg, str) {
  return str.split(" ").map(word => word.toLowerCase() === wordArg.toLowerCase() ? `**${word.toUpperCase()}**` : word).join(' ')
}
